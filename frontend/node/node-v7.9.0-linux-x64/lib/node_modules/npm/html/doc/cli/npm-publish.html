...
Sets tag &#39;latest&#39; if no --tag specified
  ...
  <p>Publishes a package to the registry so that it can be installed by name. All
    ...
    <code><a href="../misc/npm-developers.html">npm-developers(7)</a></code> for full details on
    what&#39;s included in the published
  ...
  <p>By default npm will publish to the public registry. This can be overridden by
    specifying a different default registry or using a <code><a href="../misc/npm-scope.html">npm-scope(7)</a></code>
    in the name
  ...
  <ul>
    ...
    <li><p><code>[--tag &lt;tag&gt;]</code>
      Registers the published package with the given tag, such that <code>npm install
        &lt;name&gt;@&lt;tag&gt;</code> will install this version. By default, <code>npm
  ...
  <p>For a &quot;dry run&quot; that does everything except actually publishing to the
    registry, see <code><a href="../cli/npm-pack.html">npm-pack(1)</a></code>, which figures out
    the files to be included and

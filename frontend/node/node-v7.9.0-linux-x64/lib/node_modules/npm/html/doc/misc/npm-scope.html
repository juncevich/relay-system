...
<div id="wrapper">
  ...
  <p>Scoped packages are installed to a sub-folder of the regular installation
    ...
    folder (<code>@myorg</code>) is simply the name of the scope preceded by an <code>@</code>
    symbol, and can
  ...
  <h3 id="publishing-public-scoped-packages-to-the-primary-npm-registry">Publishing public scoped
    packages to the primary npm registry</h3>
  ...
  <h3 id="publishing-private-scoped-packages-to-the-npm-registry">Publishing private scoped
    packages to the npm registry</h3>

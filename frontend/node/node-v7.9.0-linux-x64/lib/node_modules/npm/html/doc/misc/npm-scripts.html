...
<div id="wrapper">
  ...
  <p>Since <code>npm@1.1.71</code>, the npm CLI has run the <code>prepublish</code> script for both
    <code>npm
      publish</code> and <code>npm install</code>, because it&#39;s a convenient way to prepare a
    package
  ...
  <p><strong>IMPORTANT:</strong> As of <code>npm@5</code>, <code>prepublish</code> will
    <em>only</em> be run for <code>npm
      publish</code>. This will make its behavior identical to <code>prepublishOnly</code>, so
    <code>npm@6</code> or later may drop support for the use of <code>prepublishOnly</code>, and
    then
    maybe we can all forget this embarrassing thing ever happened.</p>
  <p>See <a
    href="https://github.com/npm/npm/issues/10074">https://github.com/npm/npm/issues/10074</a> for
    a much lengthier
  ...
  <p>The advantage of doing these things at <code>prepublish</code> time is that they can be done
    once, in a
  ...
  <ul>
    ...
    <li><p><code>&quot;install&quot;: &quot;node-gyp rebuild&quot;</code>:</p>
      <p>If there is a <code>binding.gyp</code> file in the root of your package and you
        haven&#39;t defined your own <code>install</code> or <code>preinstall</code> scripts, npm
        will
...
, &quot;scripts&quot;: { &quot;start&quot; : &quot;bar ./test&quot; } }
  ...
  <p>The package.json &quot;config&quot; keys are overwritten in the environment if
    there is a config param of <code>&lt;name&gt;[@&lt;version&gt;]:&lt;key&gt;</code>. For
    example,
...
, &quot;scripts&quot; : { &quot;start&quot; : &quot;node server.js&quot; } }
  ...
  <p>Objects are flattened following this format, so if you had
    <code>{&quot;scripts&quot;:{&quot;install&quot;:&quot;foo.js&quot;}}</code> in your
  ...
  <ul>
    ...
    <li>Try not to use scripts to do what npm can do for you. Read through
      <code><a href="../files/package.json.html">package.json(5)</a></code> to see all the things
      that you can specify and enable
      by simply describing your package appropriately. In general, this
      will lead to a more robust and consistent state.
    </li>
    <li>Inspect the env to determine where to put things. For instance, if
      the <code>npm_config_binroot</code> environment variable is set to
      <code>/home/user/bin</code>, then
    ...
    <li>Don&#39;t use <code>install</code>. Use a <code>.gyp</code> file for compilation, and
      ...
      there is another option. The only valid use of <code>install</code> or

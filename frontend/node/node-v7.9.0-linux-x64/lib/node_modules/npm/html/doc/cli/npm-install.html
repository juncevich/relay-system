...
common options: [-S|--save|-D|--save-dev|-O|--save-optional] [-E|--save-exact] [-B|--save-bundle] [--dry-run]
  ...
  <ul>
    <li>a) a folder containing a program described by a <code><a href="../files/package.json.html">package.json(5)</a></code>
      file
    </li>
    <li>b) a gzipped tarball containing (a)</li>
    <li>c) a url that resolves to (b)</li>
    <li>d) a <code>&lt;name&gt;@&lt;version&gt;</code> that is published on the registry (see
      <code><a href="../misc/npm-registry.html">npm-registry(7)</a></code>) with (c)
    </li>
  ...
  <ul>
    <li><p><code>npm install</code> (in package directory, no arguments):</p>
      ...
      <p> In global mode (ie, with <code>-g</code> or <code>--global</code> appended to the
        command),
    ...
    <li><p><code>npm install [&lt;@scope&gt;/]&lt;name&gt;
      [-S|--save|-D|--save-dev|-O|--save-optional]</code>:</p>
      <p> Do a <code>&lt;name&gt;@&lt;tag&gt;</code> install, where <code>&lt;tag&gt;</code> is the
        &quot;tag&quot; config. (See
        <code><a href="../misc/npm-config.html">npm-config(7)</a></code>. The config&#39;s default
        value is <code>latest</code>.)</p>
      ...
      <ul>
        ...
        <li><p><code>-D, --save-dev</code>: Package will appear in your
          <code>devDependencies</code>.</p>
        </li>
        ...
        <li><p><code>-B, --save-bundle</code>: Saved dependencies will also be added to your <code>bundleDependencies</code>
          ...
          <p>Further, if you have an <code>npm-shrinkwrap.json</code> then it will be updated as
            well.</p>
          <p><code>&lt;scope&gt;</code> is optional. The package will be downloaded from the
            registry
            associated with the specified scope. If no registry is associated with
            the given scope the default registry is assumed. See <code><a
  ...
  <ul>
    ...
    <li><p><code>npm install &lt;git remote url&gt;</code>:</p>
      <p> Installs the package from the hosted git provider, cloning it with
        <code>git</code>. First it tries via the https (git with github) and if that fails, via
        ssh.</p>
...
GIT_SSH_COMMAND=&#39;ssh -i ~/.ssh/custom_ident&#39; npm install git+ssh://git@github.com:npm/npm.git
    ...
    <li><p><code>npm install
      github:&lt;githubname&gt;/&lt;githubrepo&gt;[#&lt;commit-ish&gt;]</code>:</p>
    ...
    <li><p><code>npm install gist:[&lt;githubname&gt;/]&lt;gistID&gt;[#&lt;commit-ish&gt;]</code>:
    </p>
      <p> Install the package at <code>https://gist.github.com/gistID</code> by attempting to
        ...
        optional and will not be saved in <code>package.json</code> if <code>-S</code> or <code>--save</code>
        is used.</p>
      <p> If you don&#39;t specify a <em>commit-ish</em> then <code>master</code> will be used.</p>
      <p> Example:</p>
    ...
    <li><p><code>npm install bitbucket:&lt;bitbucketname&gt;/&lt;bitbucketrepo&gt;[#&lt;commit-ish&gt;]</code>:
    </p>
    ...
    <li><p><code>npm install
      gitlab:&lt;gitlabname&gt;/&lt;gitlabrepo&gt;[#&lt;commit-ish&gt;]</code>:</p>
  ...
  <p>The <code>-g</code> or <code>--global</code> argument will cause npm to install the package
    globally
    rather than locally. See <code><a href="../files/npm-folders.html">npm-folders(5)</a></code>.
  </p>
  ...
  <p>The <code>--ignore-scripts</code> argument will cause npm to not execute any
    scripts defined in the package.json. See <code><a href="../misc/npm-scripts.html">npm-scripts(7)</a></code>.
  </p>
  ...
  <p>The <code>--only={prod[uction]|dev[elopment]}</code> argument will cause either only
    <code>devDependencies</code> or only non-<code>devDependencies</code> to be installed
    regardless of the <code>NODE_ENV</code>.</p>
  <p>See <code><a href="../misc/npm-config.html">npm-config(7)</a></code>. Many of the
...
+-- D@1
  ...
  <p>See <a href="../files/npm-folders.html">npm-folders(5)</a> for a more detailed description of
    the specific
  ...
  <p>where <code>A</code> is some version of a package, and <code>A&#39;</code> is a different
    version

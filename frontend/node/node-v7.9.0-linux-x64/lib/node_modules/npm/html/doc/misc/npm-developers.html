...
<div id="wrapper">
  ...
  <ul>
    ...
    <li>d) a <code>&lt;name&gt;@&lt;version&gt;</code> that is published on the registry with (c)
    </li>
...
git+https://user@hostname/project/blah.git#commit-ish
  ...
  <p>See <code><a href="../files/package.json.html">package.json(5)</a></code> for details about
    what goes in that file. At the very
    least, you need:</p>
  <ul>
    <li><p>name:
      ...
      <p>So, <code>node-foo</code> and <code>bar-js</code> are bad names. <code>foo</code> or
        <code>bar</code> are better.</p>
    </li>
    <li><p>version:
    ...
    <li><p>directories:
      ...
      &quot;lib&quot; and &quot;doc&quot;, but if you use &quot;man&quot; to specify a folder full
      of man pages,
  ...
  <p>Use a <code>.npmignore</code> file to keep stuff out of your package. If there&#39;s
    no <code>.npmignore</code> file, but there <em>is</em> a <code>.gitignore</code> file, then npm
    will
    ...
    create an empty <code>.npmignore</code> file to override it. Like <code>git</code>,
    <code>npm</code> looks
  ...
  <h2 id="before-publishing-make-sure-your-package-installs-and-works">Before Publishing: Make Sure
    Your Package Installs and Works</h2>

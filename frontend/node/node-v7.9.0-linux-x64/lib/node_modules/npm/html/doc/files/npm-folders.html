...
<div id="wrapper">
  ...
  <ul>
    ...
    <li>Install it <strong>globally</strong> if you&#39;re going to run it on the command line.
    </li>
  ...
  <p>See <code><a href="../cli/npm-cache.html">npm-cache(1)</a></code>. Cache files are stored in
...
+-- node_modules
  ...
  <p>Bar [B] also has dependencies on baz and asdf, so those are installed in
    bar&#39;s <code>node_modules</code> folder. Because it depends on <code>baz@2.x</code>, it
    cannot
  ...
  <p>This allows a package maintainer to install all of their dependencies
    ...
    cannot be found elsewhere. See <code><a
      href="../files/package.json.html">package.json(5)</a></code> for more information.</p>

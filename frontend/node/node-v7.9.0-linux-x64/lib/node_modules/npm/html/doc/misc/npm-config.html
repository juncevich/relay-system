...
<div id="wrapper">
  ...
  <p>Putting <code>--foo bar</code> on the command line sets the <code>foo</code> configuration
    parameter to <code>&quot;bar&quot;</code>. A <code>--</code> argument tells the cli parser to
    stop
  ...
  <ul>
    ...
    <li>per-user configuration file (defaults to <code>$HOME/.npmrc</code>; configurable via CLI
      option <code>--userconfig</code> or environment variable <code>$NPM_CONF_USERCONFIG</code>)
    </li>
    <li>global configuration file (defaults to <code>$PREFIX/etc/npmrc</code>; configurable via
      CLI option <code>--globalconfig</code> or environment variable
      <code>$NPM_CONF_GLOBALCONFIG</code>)
    </li>
...
npm ls --global --parseable --long --loglevel info
  ...
  <p>When running scripts (see <code><a href="../misc/npm-scripts.html">npm-scripts(7)</a></code>)
...
, &quot;scripts&quot; : { &quot;start&quot; : &quot;node server.js&quot; } }
  ...
  <p>When publishing scoped packages, the access level defaults to <code>restricted</code>. If
    ...
    <code>--access=public</code>. The only valid values for <code>access</code> are
    <code>public</code> and
    <code>restricted</code>. Unscoped packages <em>always</em> have an access level of
    <code>public</code>.</p>
...
ca[]=&quot;...&quot;
  ...
  <p>The location of npm&#39;s cache directory. See <code><a href="../cli/npm-cache.html">npm-cache(1)</a></code>
  </p>
  ...
  <p>For <code>npm outdated</code>, a setting of <code>Infinity</code> will be treated as
    <code>0</code>
  ...
  <ul>
    <li>Default: <code>EDITOR</code> environment variable if set, or <code>&quot;vi&quot;</code> on
      Posix,
  ...
  <p>Operates in &quot;global&quot; mode, so that packages are installed into the
    ...
    <code><a href="../files/npm-folders.html">npm-folders(5)</a></code> for more on the differences
    in behavior.</p>
  <ul>
    <li>packages are installed into the <code>{prefix}/lib/node_modules</code> folder, instead of
      the
  ...
  <p>Causes npm to install the package into your local <code>node_modules</code> folder with
    ...
    eliminate some deduping. If used with <code>legacy-bundling</code>,
    <code>legacy-bundling</code> will be
    preferred.</p>
  ...
  <p>A proxy to use for outgoing https requests. If the <code>HTTPS_PROXY</code> or
    <code>https_proxy</code> or <code>HTTP_PROXY</code> or <code>http_proxy</code> environment
    variables are set,
  ...
  <p>If true, npm will not exit with an error code when <code>run-script</code> is invoked for
    a script that isn&#39;t defined in the <code>scripts</code> section of
    <code>package.json</code>. This
  ...
  <p>The value <code>npm init</code> should use by default for the package author&#39;s homepage.
  </p>
  ...
  <p>This feature is currently experimental, and the output data structures for many
    ...
    output from <code>npm ls --json</code> and <code>npm search --json</code> are currently valid.
  </p>
  <h3 id="key">key</h3>
  <ul>
    <li>Default: <code>null</code></li>
  ...
  <ul>
    <li>Default: &quot;warn&quot;</li>
    <li>Type: String</li>
    <li>Values: &quot;silent&quot;, &quot;error&quot;, &quot;warn&quot;, &quot;http&quot;, &quot;info&quot;,
      &quot;verbose&quot;, &quot;silly&quot;
    </li>
  </ul>
  ...
  <p>When &quot;dev&quot; or &quot;development&quot; and running local <code>npm install</code>
    without any
    arguments, only devDependencies (and their dependencies) are installed.</p>
  <p>When &quot;dev&quot; or &quot;development&quot; and running local <code>npm ls</code>, <code>npm
    outdated</code>, or
    <code>npm update</code>, is an alias for <code>--dev</code>.</p>
  <p>When &quot;prod&quot; or &quot;production&quot; and running local <code>npm install</code>
    without any
    arguments, only non-devDependencies (and their dependencies) are
    installed.</p>
  <p>When &quot;prod&quot; or &quot;production&quot; and running local <code>npm ls</code>, <code>npm
    outdated</code>, or
  ...
  <p>For example if a package has version <code>1.2.3</code>, by default its version is
    ...
    <code>npm config set save-prefix=&#39;~&#39;</code> it would be set to <code>~1.2.3</code>
    which only allows
    patch upgrades.</p>
  ...
  <p>If set to <code>true</code>, add the directory in which the current <code>node</code>
    executable
    resides to the <code>PATH</code> environment variable when running scripts,
    even if that means that <code>npm</code> will invoke a different <code>node</code> executable
    than
    the one which it is running.</p>
  <p>If set to <code>false</code>, never modify <code>PATH</code> with that.</p>
  <p>If set to <code>&quot;warn-only&quot;</code>, never modify <code>PATH</code> but print a
    warning if <code>npm</code> thinks
    that you may want to run it with <code>true</code>, e.g. because the <code>node</code>
    executable
    in the <code>PATH</code> is not the one <code>npm</code> was invoked with.</p>
  <p>If set to <code>auto</code>, only add that directory to the <code>PATH</code> environment
    variable
    if the <code>node</code> executable with which <code>npm</code> was invoked and the one that is
    found
  ...
  <p>Set to show short usage output (like the -H output)
    instead of complete help when doing <code><a href="../cli/npm-help.html">npm-help(1)</a></code>.
  </p>
  <h3 id="user">user</h3>
  <ul>
  ...
  <p>Set to <code>&quot;browser&quot;</code> to view html help content in the default web browser.
  </p>

...
<div id="wrapper">
  ...
  <p><a href="https://travis-ci.org/npm/npm"><img
    src="https://img.shields.io/travis/npm/npm/latest.svg" alt="Build Status"></a></p>
  ...
  <p>You can configure npm to use any compatible registry you
    like, and even run your own registry. Check out the <a
      href="https://docs.npmjs.com/misc/registry">doc on
      registries</a>.</p>
  ...
  <p>There&#39;s a pretty robust install script at
    <a href="https://www.npmjs.com/install.sh">https://www.npmjs.com/install.sh</a>. You can
    download that and run it.</p>
  ...
  <p>Many improvements for Windows users have been made in npm 3 - you will have a better
    ...
    <a href="https://github.com/npm/npm/wiki/Troubleshooting#upgrading-on-windows">npm

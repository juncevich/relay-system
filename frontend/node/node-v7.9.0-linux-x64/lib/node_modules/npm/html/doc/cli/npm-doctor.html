...
<div id="wrapper">
  ...
  <p>While it&#39;s documented in the <a href="../../doc/README.html">README</a>, it may not be
    obvious that npm needs Git
  ...
  <ul>
    ...
    <li>Your local <code>node_modules</code> path, if you&#39;re running <code>npm doctor</code>
      with a project
  ...
  <p>When an npm package is published, the publishing process generates a checksum
    ...
    in your local cache (you can see where that cache is located with <code>npm config
      get cache</code>, and see what&#39;s in that cache with <code>npm cache ls</code> – probably
    more

...
`-- B@0.0.2
  ...
  <p>This generates <code>npm-shrinkwrap.json</code>, which will look something like this:</p>
  <pre><code>{
  &quot;name&quot;: &quot;A&quot;,
  &quot;version&quot;: &quot;0.1.0&quot;,
  &quot;dependencies&quot;: {
  ...
  <p>If <code>preshrinkwrap</code>, <code>shrinkwrap</code> or <code>postshrinkwrap</code> are in
    the <code>scripts</code> property of the
  ...
  <ol>
    ...
    <li>Add or update dependencies. <code>npm install --save</code> or <code>npm install
      --save-dev</code>
  ...
  <p>You can use <a href="../cli/npm-outdated.html">npm-outdated(1)</a> to view dependencies with
    newer versions
    available.</p>
  ...
  <p>Starting with npm v4.0.1, <code>devDependencies</code> are included when you run
    ...
    variable <code>NODE_ENV</code> is <code>production</code> then they won&#39;t be installed. If
    you
